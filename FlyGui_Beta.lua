...
SettingsFrame.Size = UDim2.fromOffset(220, 158)
...
for i = 1, 8 do
	...
	-- Slot 1 giữ riêng cho console / input đặc biệt
	if i == 1 then
		Slots[1] = {
			Frame = slot,
			Type = "Console"
...
row.Position = UDim2.fromOffset(1, 4)
row.ZIndex = 21
...
spBox.Size = UDim2.fromOffset(80, 28)
...
row3.Position = UDim2.fromOffset(1, 4)
...
slot3UpBtn.Size = UDim2.fromOffset(39, 28)
slot3UpBtn.Text = ""
...
slot3DownBtn.Size = UDim2.fromOffset(39, 28)
slot3DownBtn.Text = ""
...
row5.Position = UDim2.fromOffset(1, 4)
...
saveBtn.Parent = row5
saveBtn.Size = UDim2.fromOffset(39, 28)
saveBtn.Text = "Save"
