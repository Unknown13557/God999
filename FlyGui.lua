...
local function setState(state)
	...
	if state then
		...
		Noclip.Pill.BackgroundColor3 = Color3.fromRGB(120,200,120)

		Noclip.SlotKnob:TweenPosition(
			UDim2.fromOffset(20,2),
			Enum.EasingDirection.Out,
			Enum.EasingStyle.Quad,
			0.15,
		...
		Noclip.Pill.BackgroundColor3 = Color3.fromRGB(80,80,80)
...
Noclip.Pill.MouseButton1Click:Connect(function()
	setState(not Noclip.State)
end)

UpdateController:On("ForceDisable",function(name)

	if name == "Noclip" and Noclip.State then
		setState(false)
	end
